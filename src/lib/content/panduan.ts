...
const PANDUAN: Record<Lang, Record<KategoriName, PanduanHari>> = {
  id: {
    GURU: {
      ...
      postpone: ["Tidak ada pantangan khusus hari ini"],
  ...
  en: {
    GURU: {
      ...
      postpone: ["No special restrictions today"],
    ...
    RATU: {
      ...
      postpone: ["Immature large investment decisions", "Confrontations or heated debates"],
