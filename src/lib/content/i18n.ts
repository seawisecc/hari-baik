...
const dict = {
  id: {
    ...
    "action.title": "Tautan dari email",
    "action.verified": "Email kamu sudah terkonfirmasi. Selamat datang di Hari Baik.",
    "action.recovered": "Alamat email kamu sudah dikembalikan.",
    "action.passwordChanged": "Kata sandi baru sudah tersimpan.",
    "action.resetFor": "Kata sandi baru untuk {email}.",
    "action.savePassword": "Simpan kata sandi baru",
    "action.toApp": "Buka Hari Baik",
    "action.noCode": "Tautannya tidak lengkap. Buka lagi langsung dari emailnya.",
    "action.unknownMode": "Tautan ini tidak dikenali. Buka lagi langsung dari emailnya.",
    "auth.or": "atau",
    ...
    "admin.filter.unverified": "Belum verifikasi",
    ...
    "promo.off": "Potongan {n}%",
    "promo.normalPrice": "Harga normal",
    "promo.free": "Gratis",
    "promo.bonusTitle": "Bonus yang ikut",
    "promo.saveTotal": "Hemat {v}",
    "promo.take": "Ambil promo ini",
    "promo.buySeparately": "Beli terpisah {v}",
    "promo.included": "Termasuk",
    "promo.notIncluded": "Tidak termasuk",
    "promo.countdown": "Promo berakhir dalam",
    "promo.d": "Hari",
    "promo.h": "Jam",
    "promo.m": "Menit",
    "promo.s": "Detik",
    ...
    "promo.mShort": "m",
    "promo.sShort": "d",
    "promo.srEnds": "Promo berakhir dalam {n} hari",
    "promo.upTo": "Potongan sampai {n}%",
    "promo.saveUpTo": "Hemat sampai {v}",
    "promo.bonusFree": "Add-on bonus ikut gratis",
    "promo.close": "Tutup penawaran ini",
    "promo.after":
      "Lewat tanggal itu harganya kembali normal dengan sendirinya, tanpa perlu ada yang menekan apa pun.",
    "landing.compare.title": "Bandingkan ketiga paketnya",
    "landing.compare.lead":
      "Angka yang sama, dijejerkan supaya kelihatan bedanya. Bonusnya melekat ke paket, jadi tidak perlu dibeli lagi belakangan.",
    "landing.compare.price": "Harga promo",
    "landing.compare.normal": "Harga normal",
    "landing.compare.perYear": "Per tahun",
    "landing.compare.access": "Masa akses",
    "landing.compare.pro": "Semua fitur Pro",
    "landing.compare.save": "Total hemat",
    "landing.compare.years": "{n} tahun",
    "landing.compare.plan": "Paket",
  ...
  en: {
    ...
    "action.title": "Link from your email",
    "action.verified": "Your email is confirmed. Welcome to Hari Baik.",
    "action.recovered": "Your email address has been restored.",
    "action.passwordChanged": "Your new password has been saved.",
    "action.resetFor": "New password for {email}.",
    "action.savePassword": "Save new password",
    "action.toApp": "Open Hari Baik",
    "action.noCode": "The link is incomplete. Open it straight from the email again.",
    "action.unknownMode": "This link is not recognised. Open it straight from the email again.",
    "auth.or": "or",
    ...
    "admin.filter.unverified": "Unverified",
    "admin.col.user": "User",
    "admin.col.status": "Status",
    ...
    "price.promo": "Limited-time promo",
    "price.promoHint":
    ...
    "price.promoDiscount": "Discount percent",
    "price.promoNoDiscount": "No discount",
    "price.promoBonusFixed": "Bonus (set in code)",
    ...
    "promo.off": "{n}% off",
    "promo.normalPrice": "Regular price",
    "promo.free": "Free",
    "promo.bonusTitle": "Included as a bonus",
    "promo.saveTotal": "Save {v}",
    "promo.take": "Take this promo",
    "promo.buySeparately": "Bought separately {v}",
    "promo.included": "Included",
    "promo.notIncluded": "Not included",
    ...
    "promo.mShort": "m",
    "promo.sShort": "s",
    "promo.srEnds": "The promo ends in {n} days",
    "promo.upTo": "Up to {n}% off",
    "promo.saveUpTo": "Save up to {v}",
    "promo.bonusFree": "Bonus add-ons included free",
    "promo.close": "Dismiss this offer",
    "promo.after":
      "Past that date the price goes back to normal on its own, with nobody having to press anything.",
    "landing.compare.title": "Compare the three plans",
    "landing.compare.lead":
      "The same numbers, side by side, so the difference is visible. The bonuses belong to the plan, so there is nothing to buy again later.",
    "landing.compare.price": "Promo price",
    "landing.compare.normal": "Regular price",
    "landing.compare.perYear": "Per year",
    "landing.compare.access": "Access period",
    "landing.compare.pro": "Every Pro feature",
    "landing.compare.save": "Total saving",
    "landing.compare.years": "{n} years",
    "landing.compare.plan": "Plan",
