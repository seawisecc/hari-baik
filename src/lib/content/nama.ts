...
export const UNSUR_INTERP: Record<UnsurNama, string> = {
  ...
  "Bhuana": "Baik. Nama ini mendukung kedudukan dan kemakmuran. Perjalanan hidup cenderung positif, meski kadang ada dinamika kecil di sisi kesehatan atau keharmonisan rumah tangga yang perlu dijaga.",
